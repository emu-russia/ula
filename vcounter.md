...
- [specs/seq.md](/specs/seq.md) — инвентаризация всех триггероподобных блоков
  нетлиста (issue #7): типы ячеек, картинки-вырезки из аннотированного нетлиста
  и сверка написанного здесь с текущими нетлистом/HDL (какие вентили реально
  формируют `vclk2` и `vrst`, у каких битов есть `vrst`, что осталось вынести в
  модули HDL).