...
счётные ячейки H/V счётчиков (`TCE`, `TRCE`, `TRC`), сдвиговый регистр и
арбитр `contention` — собраны в [specs/seq.md](/specs/seq.md): инвентаризация
65 запоминающих кластеров по модулям, вырезки из аннотированного нетлиста
(`imgstore/seq/*.png`, генератор — [tools/gen_seq_crops.py](/tools/gen_seq_crops.py))
и список того, что ещё осталось свёрнуто в модули HDL.
