...
Описание всех модулей (анализ, схемы, waves, C++) — [docs/ula-modules.md](/docs/ula-modules.md);
схемы модулей: `imgstore/schematics/s_*.png`, типовые waves: `imgstore/waves/w_*.png`;
таблица всех внутренних сигналов (откуда/куда/описание) — [docs/ula-signals.md](/docs/ula-signals.md).
