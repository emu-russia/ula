...
Описание всех модулей (анализ, схемы, waves, C++) — [specs/ula-modules.md](/specs/ula-modules.md);
схемы модулей: `imgstore/schematics/s_*.png`, типовые waves: `imgstore/waves/w_*.png`;
таблица всех внутренних сигналов (откуда/куда/описание) — [specs/ula-signals.md](/specs/ula-signals.md).
